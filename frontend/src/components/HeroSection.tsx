    ...
    <div className="relative w-full h-screen min-h-screen flex items-center justify-center overflow-hidden bg-gray-900">
      ...
      >
        ...
        <motion.div variants={headlineVariants} className="mb-4 sm:mb-6">
          <h1 className="text-6xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-white mb-2 sm:mb-4 leading-tight">
            Find Your Perfect
            <motion.span
        ...
        >
          <p className="text-xl sm:text-xl lg:text-xl xl:text-2xl text-gray-200 leading-relaxed font-light">
        ...
        >
          <div className="text-center">
            <div className="text-lg sm:text-2xl font-bold text-amber-400">50K+</div>
            <div className="text-xs sm:text-sm">Happy Customers</div>
          </div>
          <div className="w-px h-6 sm:h-8 bg-white/20" />
          <div className="text-center">
            <div className="text-lg sm:text-2xl font-bold text-amber-400">100K+</div>
            <div className="text-xs sm:text-sm">Products</div>
          </div>
          <div className="w-px h-6 sm:h-8 bg-white/20" />
          <div className="text-center">
            <div className="text-lg sm:text-2xl font-bold text-amber-400">4.9★</div>
