          ...
          <div className="flex-shrink-0 group">
            ...
            >
              <img 
                ...
                className="h-14 w-auto max-w-[200px] object-contain transform group-hover:scale-105 transition-transform duration-300 drop-shadow-lg"
              />
            </Link>
          </div>
          ...
          <div className="flex-shrink-0">
            ...
            >
              <img 
                src="/Asset 5.png" 
                alt="Ashraf Furnitures Logo" 
                className="h-10 w-auto max-w-[150px] object-contain drop-shadow-md"
              />
            </Link>
          </div>
